...
public:
    ...
    void play() {
        ...
        while (!board.isFull()) {
            ...
            while (true) {
                ...
                if (board.isValidMove(row, col)) {
                    ...
                    cout << " you have pressed a Invalid row and column . Try again." << endl;
                }
            }
            ...
            if (board.checkWin(currentPlayer.getSymbol())) {
                board.drawBoard();
                cout << currentPlayer.getName() << " wins! congrats" << endl;
                return;
            }
        ...
        board.drawBoard();
        cout << "It's a draw! both played a nice game congrats" << endl;
    }
};
